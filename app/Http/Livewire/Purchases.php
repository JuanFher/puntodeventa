...
class Puchases extends Component
{
    ...
    public $product_id, $quantity, $buy_price, $sell_price, $subtotal, $taxiva, $itemtotal; // para la table de detalle del producto 
    public $selected_id, $search; //seleccionar y buscar
    public $providers, $provider, $products;// para los listados
    public $orderProducts = []; // array del detalle de productos
    public $action = 1;
    ...
    public function render()
    {
        ...
        if ($this->selecte_id > 0) {
            $this->provider = Provider::find($this->selecte_id);
            $this->provider_id = $this->provider->id;
            return view('livewire.puchases', [
    ...
    public function storeOrder()
    {
        ...
        return redirect()->route('puchases.index');
